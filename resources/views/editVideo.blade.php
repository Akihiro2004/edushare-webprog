...
<div class="bg-gradient-to-br from-[#2a0d47] to-[#1a234d] min-h-screen">
    <div class="max-w-6xl mx-auto px-6 py-20 relative">
        ...
        <div class="relative text-center mb-12">
            ...
            <h1 class="text-4xl font-bold text-white mb-4">Edit Video</h1>
            <p class="text-gray-300 max-w-2xl mx-auto">
                Update the video information below. All fields are required to ensure proper cataloging.
            </p>
        </div>

        <form action="{{ route('updateVideo', $video) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                        ...
                        <div class="col-span-12 lg:col-span-4">
                            <div class="space-y-3">
                                ...
                                <div class="relative group aspect-video border-2 border-dashed border-white/20 rounded-2xl
                                    ...
                                    <div id="defaultUploadContent" class="absolute inset-0 flex flex-col items-center justify-center p-6 {{ $video->thumbnail ? 'hidden' : '' }}">
                                    ...
                                    <div id="previewContainer" class="absolute inset-0 {{ $video->thumbnail ? '' : 'hidden' }}">
                                        <img id="imagePreview"
                                        ...
                                        <div class="absolute bottom-0 inset-x-0 bg-black/50 p-3 text-center">
                                            <p id="fileName" class="text-sm text-white truncate">Current thumbnail</p>
                                        </div>
                                    </div>
                        ...
                        <div class="col-span-12 lg:col-span-8 space-y-8">
                            <div class="grid grid-cols-2 gap-6">
                                <div class="col-span-2 space-y-3">
                                    ...
                                    <input type="text" name="title" required value="{{ $video->title }}"
                                           placeholder="Enter the complete title of the video"
                                ...
                                <div class="col-span-2 md:col-span-1 space-y-3">
                                    ...
                                    <input type="text" name="creator" required value="{{ $video->creator }}"
                                           placeholder="Name of the content creator"
                                           class="w-full px-4 py-3.5 rounded-xl bg-white/5 border border-white/10
                                                  text-white placeholder:text-white/30
                                                  focus:outline-none focus:border-white/30 focus:ring-4 focus:ring-white/10
                                                  hover:border-white/20 hover:bg-white/[0.075]
                            ...
                            <div class="space-y-3">
                                ...
                                <textarea name="description" required
                                          ...
                                          class="w-full px-4 py-3.5 rounded-xl bg-white/5 border border-white/10
                                                 ...
                                                 focus:outline-none focus:border-white/30 focus:ring-4 focus:ring-white/10
                                                 hover:border-white/20 hover:bg-white/[0.075]
                                                 transition-all duration-300">{{ $video->description }}</textarea>
                            </div>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <div class="col-span-2 md:col-span-1 space-y-3">
                                    ...
                                    <input type="date" name="publish_date" required value="{{ $video->publish_date }}"
                                           class="w-full px-4 py-3.5 rounded-xl bg-white/5 border border-white/10
                                                  text-white/80
                                                  focus:outline-none focus:border-white/30 focus:ring-4 focus:ring-white/10
                                                  hover:border-white/20 hover:bg-white/[0.075]
                                ...
                                <div class="col-span-2 md:col-span-1 space-y-3">
                                    ...
                                    <input type="url" name="url" required value="{{ $video->url }}"
                    ...
                    <div class="px-10 py-6 relative flex items-center justify-between">
                        ...
                        <button type="submit"
                                class="group inline-flex items-center gap-3 px-8 py-3.5
                                       ...
                                       backdrop-blur-sm
                                       transition-all duration-300">
                            <span class="text-sm font-medium text-white">Update Video</span>
